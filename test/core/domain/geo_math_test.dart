...
void main() {
  test('pointAlongPolyline returns midpoint by route distance', () {
    final midpoint = pointAlongPolyline(const [
  ...
  test(
    'simplifyPolylineForDisplay preserves meaningful bends and caps output',
    () {
      final points = <GeoPoint>[
        ...
        for (var index = 1; index <= 40; index++)
          GeoPoint(latitude: 45.01 + index * 0.00001, longitude: 11.01),
      ];
